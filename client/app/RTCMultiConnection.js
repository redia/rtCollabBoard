...
(function() {
    ...
    function setDefaults(connection) {
        ...
        connection.onFileEnd = function(file) {
            if (progressHelper[file.uuid]) progressHelper[file.uuid].div.innerHTML = '<a href="' + file.url + '" target="_blank" download="' + file.name + '">' + file.name + '</a> 파일이 공유되었습니다. 파일명을 클릭하면 다운로드가 가능합니다.';
